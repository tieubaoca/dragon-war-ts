...
export interface DragonCoreReadOnlyInterface {
...
export class DragonCoreQueryClient implements DragonCoreReadOnlyInterface {
  ...
  constructor(client: CosmWasmClient, contractAddress: string) {
    ...
    this.canMateWith = this.canMateWith.bind(this);
    this.isReadyToMate = this.isReadyToMate.bind(this);
    this.isPregnant = this.isPregnant.bind(this);
...
export interface DragonCoreInterface extends DragonCoreReadOnlyInterface {
  contractAddress: string;
  sender: string;
  transferNft: ({
    recipient,
...
export class DragonCoreClient extends DragonCoreQueryClient implements DragonCoreInterface {
